...
class zlkbcodepay_config{   
	function get_configuration ($paymethod){
		...
		$base_config = ["FriendlyName" => ['Type' => 'System','Value' => $displayName]];
